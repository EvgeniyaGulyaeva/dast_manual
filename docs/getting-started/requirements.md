...
2. Установленное ПО DAST / доступ к веб-версии — что за ПО? где его взять? функциональность десктопа и веб версии не отличается? 

3. Автомобиль поставлен в сервисный режим — как это узнать? кто должен это знать? 

4. Зарегистрированный доступ к автомобилю (владелец передал в сервис) — это видно на AS портале? что если доступа нет? можно ли дать владельцу инструкцию типа "пойди туда, нажми это"? 
...
У автомобиля диагностический разъем будет стандартный OBD-II, Ethernet заведен на 12,13 и 1,9 пины. ещё в OBD-II разъёме кабеля должна быть перемычка (шунт) между пинами 8 и 16.
